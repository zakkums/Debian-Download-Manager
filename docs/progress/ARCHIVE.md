...
This file contains sections moved out of `PROGRESS.md` to keep that file under the
project guideline of **< 200 lines per file**, while preserving all historical notes.
